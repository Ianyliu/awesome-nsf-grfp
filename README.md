...
**A curated collection of example essays, research proposals, writing advice, workshops, and application resources for the NSF Graduate Research Fellowship Program.**

[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
[![NSF GRFP](https://img.shields.io/badge/NSF-GRFP-1f6feb)](https://www.nsfgrfp.org/)
[![Resources](https://img.shields.io/badge/resources-curated-success)](#resources)
[![Contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg)](#contributing)

*Use examples for structure and inspiration—not as templates to copy. Always verify current requirements against official NSF guidance.*
...
| [Alex Matlock](https://drive.google.com/file/d/1DU-Z7g1zVSMSzJNeVfqUrxpvP7H4SiEO/view?usp=sharing) | Personal statement |
| [James Howe](https://drive.google.com/file/d/1Vo09uRLg5ihaC9gUEcm8zJRMb_CHnFSz/view?usp=sharing) | Research statement |
| [James Howe](https://drive.google.com/file/d/1F6Pwq62kpqV82SIHbo8GY4rHqnwDRcno/view?usp=sharing) | Personal statement |

## 💡 Blogs & Application Advice
...
### Structure, revision, and current guidance

- [5 Structural Mistakes I See in Almost Every NSF GRFP Draft](https://www.yaelcourtney.com/resources-and-guides/5-structural-mistakes-i-see-in-almost-every-nsf-grfp-draft-and-how-to-fix-them)
...
- [How to Write the NSF GRFP Personal Statement | Detailed Example & Tips](https://www.youtube.com/watch?v=3CLsK6FUvRQ)
...
A productive way to use these resources is to compare several successful applications rather than imitate a single one.

1. **Read for structure first.** Identify how applicants frame the problem, motivation, methods, intellectual merit, and broader impacts.
2. **Compare multiple examples.** Successful essays differ substantially by discipline and applicant background.
3. **Extract patterns, not prose.** Notice what information reviewers receive and when they receive it.
4. **Draft in your own voice.** Your application should reflect your own research direction, trajectory, and broader-impact goals.
5. **Check current NSF rules.** Eligibility, solicitation language, formatting, and review expectations can change between cycles.

> [!IMPORTANT]
> This repository is an unofficial community resource and is not affiliated with or endorsed by the National Science Foundation. Official NSF materials should always take precedence when requirements differ.

## 🤝 Contributing

Contributions are welcome. Useful additions include:

- publicly shared successful or honorable-mention applications;
- university writing-center or fellowship-office guides;
- discipline-specific GRFP advice;
- high-quality workshops or recorded information sessions; and
- corrections for broken or outdated links.

When suggesting a resource, please prefer material that is **publicly accessible, clearly attributable, and genuinely useful to applicants**.

---

<div align="center">

**⭐ If this collection helps you, consider starring the repository so other applicants can find it.**
